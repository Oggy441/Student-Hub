...
export const SCHEDULE = {
    0: [ // Monday
        ...
        { subject: 'BEEE Lab', topic: 'BEEE Lab', time: '11:30 AM - 1:30 PM', room: 'Lab No. 105', professor: 'Dr. Parvinder Kaur', type: 'P', group: 2 },
    ...
    1: [ // Tuesday
        ...
        { subject: 'EG Lab', topic: 'EG Lab', time: '2:30 - 5:30 PM', room: 'Lab No. 409', professor: 'Dr. Ashish Tuli', type: 'P', group: 1 },
    ],
    2: [ // Wednesday
        { subject: 'AC', topic: 'Applied Chemistry', time: '9:30 - 10:30 AM', room: 'Room L-3', professor: 'Ms. Neha', type: 'L', group: null },
        ...
        { subject: 'EG', topic: 'Engineering Graphics', time: '11:30 AM - 12:30 PM', room: 'Room L-3', professor: 'Dr. Ashish Tuli', type: 'L', group: null },
        { subject: 'OOPS', topic: 'Object Oriented Programming', time: '12:30 - 1:30 PM', room: 'Room L-3', professor: '', type: 'L', group: null },
        { subject: 'DET', topic: 'Differential Eq. & Transforms', time: '2:30 - 3:30 PM', room: 'Room L-3', professor: 'Dr. Tejinder Kumar', type: 'L', group: null },
    ...
    3: [ // Thursday
        ...
        { subject: 'BEEE', topic: 'Basic Electrical & Electronics', time: '12:30 - 1:30 PM', room: 'Room L-3', professor: 'Dr. Parvinder Kaur', type: 'L', group: null },
        { subject: 'EG Lab', topic: 'EG Lab', time: '2:30 - 5:30 PM', room: 'Lab No. 409', professor: 'Dr. Ashish Tuli', type: 'P', group: 2 },
        { subject: 'AC Lab', topic: 'AC Lab', time: '3:30 - 5:30 PM', room: 'Lab No. 104', professor: 'Ms. Neha', type: 'P', group: 3 },
        { subject: 'BEEE Lab', topic: 'BEEE Lab', time: '3:30 - 4:30 PM', room: 'Lab No. 105', professor: 'Dr. Parvinder Kaur', type: 'P', group: 1 },
    ],
    4: [ // Friday
        { subject: 'AC Lab', topic: 'AC Lab', time: '10:30 - 1:30 PM', room: 'Lab No. 104', professor: 'Ms. Neha', type: 'P', group: 2 },
        { subject: 'BEEE Lab', topic: 'BEEE Lab', time: '10:30 AM - 12:30 PM', room: 'Lab No. 105', professor: 'Dr. Parvinder Kaur', type: 'P', group: 3 },
        { subject: 'OOPS Lab', topic: 'OOPS Lab', time: '10:30 - 1:30 PM', room: 'CL1', professor: '', type: 'P', group: 1 },
        { subject: 'EG Lab', topic: 'EG Lab', time: '2:30 - 5:30 PM', room: 'Lab No. 409', professor: 'Dr. Ashish Tuli', type: 'P', group: 3 },
